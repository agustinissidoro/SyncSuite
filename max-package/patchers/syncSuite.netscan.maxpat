        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1137.0, 286.0, 81.0, 22.0 ],
                    "text": "prepend scan"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 4,
                    "outlettype": [ "", "", "", "" ],
                    "patching_rect": [ 180.0, 661.0, 419.0, 22.0 ],
                    "text": "route myip scan done"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 7,
                    "outlettype": [ "", "", "", "", "", "", "" ],
                    "patching_rect": [ 203.0, 109.0, 682.0, 22.0 ],
                    "text": "route start stop defer myip scan console"
                }
            },
            {
                "box": {
